...
<body>
		...
		<div class="section-inside">
			<div class="section-nav" id="section-nav">
				<ul>
					...
					<li>	
						<a href="#">
							<span id="pands">PRODUCT & SERVICES</span>
						</a>
						<div class="pands" id="pands-div">
							<ul>								
								<li>
									<a href="tangerinelms.html">
										Tangerine LMS
									</a>
								</li>
		                                                             <li>
		                                                             		<a href="tangerine-mobile.html" class="ll">
		                                                             			Tangerine Mobile
		                                                             		</a>
		                                                             	</li>
		                                                             <li>
		                                                             		<a href="tangerine-for-small-business.html" class="ll">
		                                                             			Tangerine For Small Business
		                                                             		</a>
		                                                             	</li>
		                                                             <li>
		                                                             		<a href="course-development.html" class="ll">
		                                                             			Bespoke Course Development
		                                                             		</a>
		                                                             	</li>
		                                                             <li>
		                                                             		<a href="digitizing-documents.html" class="ll">
		                                                             			Digitizing Documents 
		                                                             		</a>
		                                                             	</li>
		                                                             <li>
		                                                             		<a href="curriculum-development.html" class="ll">
		                                                             			Curriculum Development
		                                                             		</a>
		                                                             	</li>
								<li>
									<a href="terminoxxatm.html" class="ll">
										Terminoxx ATM Monitoring
									</a>
								</li>
		                                                               <li>
		                                                               	<a href="terminoxxbla.html" class="ll">
		                                                               		Terminoxx (BLA)
		                                                               	</a>
		                                                               </li>
							</ul>
			...
			<div class="section-mobile" id="section-mobile">
				<!-- MENU -->
				<img src="assets/img/sample/menu.png"/>
				<div class="mobile-nav"  id="mobile-nav">
					<ul>
						...
						<li  class="mobile-active">
							<a href="#">	
								<span id="prod">PRODUCT & SERVICES</span>
							</a>
							<div class="mobile-pands" id="mobile-pands">
								<ul>								
									<li>
										<a href="tangerinelms.html">
											Tangerine LMS
						...
						<li>
							<a href="#">
								<span id="folio">PORTFOLIO</span>
							</a>
							<div class="mobile-port" id="mobile-port">
								<ul>
									<li><a href="clients.html">Clients</a></li>
		                                                            		<li><a href="testimonial.html">Testimonials</a></li>
		                                                           		<li><a href="careers.html">Careers</a></li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="sect-about">
								...
								<p>
									Let's turn your ideas into a scalable business. We are waiting to assist you.
								</p>										
							</div>							
						</div>						
					</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="sect-profile">
						<span>Get in touch with us and let's Work Together</span>
						<p>
							We'd love to hear from you. You can either call us on  <strong>(+234)-01-013429741</strong> or you can email us on <strong>info@zercomsystems.com</strong> and one of our awesome team member will get back to you. If you have a specific question, you ca fill the form below and send to us. We love getting emails all day.
						</p>
	...
	<div class="section-2">				
		<div class="col-md-12">
			<div class="sect-map">
				<div class="sect-form" id="form-env" title="view message form">
					<i class="fa fa-envelope fa-2x"  id="sect-form"></i>
				</div>
				<div class="sect-add" id="sect-add">
					<div class="sect-address">
						...
						<div class="col-md-12">
							<div class="add-other">					
								<div title="view map" id="view-map">
						...
						<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyD2F05rPDrzX5_voW5QjVgEQKiXgxwEMtA">
						</script>
						<div style="overflow:hidden;height:500px;width:100%;">
							...
							<a class="google-map-code" href="http://www.themecircle.net" id="get-map-data">
								www.themecircle.net
							</a>
						</div>
	...
	<div class="section-footer">
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="footer-div">
						...
						<span><a href="aboutus.html">MORE</a></span>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="footer-div">
						...
						<div class="footer-contact">
							<span>NIGERIA</span>
							<p>
								3rd Floor, Engineering Building,<br>
								1, Engineering Close, NEC Building,<br>
								Off Idowu Taylor Street,<br>
								Victoria Island, <br>
								Lagos, Nigeria.
							</p>
						</div>
				...
				<div class="col-sm-3">
					<div class="footer-div">
						...
						<ul>
							...
							<li><a href="course-development.html">Bespoke Course Development</a></li>
							...
							<li><a href="terminoxxatm.html">Terminoxx ATM Monitoring</a></li>
							<li><a href="terminoxxbla.html">Terminoxx (BLA)</a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-2">
		...
		<div class="support-icon">
			<a href="http://www.zercomsupport.com" target="_blank">
				<img src="assets/img/sample/support.png"/>
				<br>
				NEED HELP?
			</a>
		</div>
			...
			<div class="row">				
				<div class="col-md-6">
					<div class="copy-text">
						...
						Zercom Systems Nigeria. All Rights Reserved
					</div>
				</div>
				<div class="col-md-6">
					<div class="copy-media">
						<ul>
							<li>
								<a href="https://www.facebook.com/zercomsystems">
									<i class="fa fa-facebook-square"></i>
								</a>
							</li>

							<li>
								<a href="https://www.youtube.com/watch?v=nEYqOa-tcZY">
									<i class="fa fa-youtube-square"></i>
								</a>
							</li>

							<li>
								<a href="https://www.linkedin.com/company/zercom-systems">
									<i class="fa fa-linkedin-square"></i>
								</a>
							</li>

							<li>
								<a href="https://www.twitter.com/zercomsystems">
									<i class="fa fa-twitter-square"></i>
								</a>
							</li>

							<li>
								<a href="callto://zercomsystems.skype">
	...
	<?php 
		...
		if (isset($_POST['submit'])) {
			...
			$headers .= "CC:  ogechi@zercomsystems.com \r\n";
...
<script type="text/javascript">
	...
	document.addEventListener("click", function(e) {
		var sectAdd = document.getElementById("sect-add");
		var viewMap = document.getElementById("view-map");
		var sectForm = document.getElementById("sect-form");
		var formDiv = document.getElementById("form-env");

		if (e.target === viewMap) {
			//console.log("i want to view map");
			sectAdd.style.display = "none";
			 formDiv.style.display = "block";
		} else if (e.target === sectForm) {
			//console.log("i want to view forn");
